...
=======
                          <td className="py-2 px-4">東京大学医学部附属病院</td>
                          <td className="py-2 px-4">東京都 (Tokyo)</td>
                          <td className="py-2 px-4">47</td>
                          <td className="py-2 px-4">42%</td>
                        </tr>
                        <tr className="border-b border-gray-800">
                          <td className="py-2 px-4">大阪大学医学部附属病院</td>
                          <td className="py-2 px-4">大阪市 (Osaka)</td>
                          <td className="py-2 px-4">42</td>
                          <td className="py-2 px-4">38%</td>
                        </tr>
                        <tr className="border-b border-gray-800">
                          <td className="py-2 px-4">名古屋大学医学部附属病院</td>
                          <td className="py-2 px-4">名古屋市 (Nagoya)</td>
                          <td className="py-2 px-4">38</td>
                          <td className="py-2 px-4">35%</td>
                        </tr>
                        <tr className="border-b border-gray-800">
                          <td className="py-2 px-4">北海道大学病院</td>
                          <td className="py-2 px-4">札幌市 (Sapporo)</td>
                          <td className="py-2 px-4">36</td>
                          <td className="py-2 px-4">32%</td>
                        </tr>
                        <tr>
                          <td className="py-2 px-4">九州大学病院</td>
                          <td className="py-2 px-4">福岡市 (Fukuoka)</td>
...
=======
                          <td className="py-2 px-4 font-medium">鈴木 優子 医師</td>
>>>>>>> dbf4e74e1de9b670c4fd88655e284ad91716af41
...
=======
                          <td className="py-2 px-4 font-medium">佐藤 健太 医師</td>
>>>>>>> dbf4e74e1de9b670c4fd88655e284ad91716af41
...
=======
                          <td className="py-2 px-4 font-medium">田中 誠 医師</td>
>>>>>>> dbf4e74e1de9b670c4fd88655e284ad91716af41
                          <td className="py-2 px-4">Oncology</td>
...
=======
                          <td className="py-2 px-4 font-medium">渡辺 美咲 医師</td>
>>>>>>> dbf4e74e1de9b670c4fd88655e284ad91716af41
...
=======
                          <td className="py-2 px-4 font-medium">伊藤 直樹 医師</td>
>>>>>>> dbf4e74e1de9b670c4fd88655e284ad91716af41
